Shiny App on Kubernetes - Google Cloud Deploy
================
...
There are a lot of other docker keywords and options you might want to
...
That’s it\! We should now have a shiny app running on k8s that we can
